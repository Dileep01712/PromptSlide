    ...
    return (
        <>
            <main className='relative flex flex-col sm:z-0 sm:mt-0'>
                <div className="pb-14 relative flex flex-col sm:z-0 sm:mt-0 bg-white">
                    {/* Header Section */}
                    <header className="lg:grid lg:grid-cols-2 mx-auto max-w-screen-xl py-5 relative px-4 lg:px-8">
                        <div className='mx-auto flex flex-col w-full relative z-10 lg:mt-24 sm:text-center lg:pr-12 lg:text-left lg:col-span-1'>
                            <h1 className="text-center font-Degular text-gray-900 mb-5 lg:text-left lg:text-5xl text-3xl">AI presentation maker</h1>
                            <p className="text-gray-800 md:text-xl mb-8 md:leading-relaxed leading-relaxed md:text-justify">
                            ...
                            <div className='flex flex-col items-center gap-2 mx-auto md:mx-0 sm:flex-row group w-48 font-Degular'>
                                <Button className="h-14 px-8 rounded-full text-white text-xl font-semibold flex items-center gap-4" onClick={() => handleButtonClick('/home')}>
                                    Get Started
                    ...
                    <div className="mx-auto">
                        <h1 className="text-center font-Degular text-gray-900 my-5 mx-10 lg:text-left lg:text-5xl text-3xl">Features</h1>
                    ...
                    <div className="lg:py-12 py-5 lg:px-8 px-4">
                        <div className='max-w-screen-md mx-auto'>
                            <h2 className="text-3xl sm:text-5xl font-semibold mb-12 text-center">
                                <span className="text-blue-600 font-Degular">How does</span> <span className="text-black font-Degular">it work?</span>
                            </h2>
                            <div className="mt-10 flex flex-col items-start justify-start gap-6">
                                <div>
                                    <h3 className='text-xl font-bold text-left mb-2 flex items-center'>Identify your central theme</h3>
                                    <p className='text-gray-800 text-left mb-6 leading-normal'>
                                ...
                                <div>
                                    <h3 className='text-xl font-bold text-left mb-2 flex items-center'>Select your design</h3>
                                    <p className='text-gray-800 text-left mb-6 leading-normal'>
                                ...
                                <div>
                                    <h3 className='text-xl font-bold text-left mb-2 flex items-center'>Polish your content for impact</h3>
                                    <p className='text-gray-800 text-left mb-6 leading-normal'>
                                ...
                                <div>
                                    <h3 className='text-xl font-bold text-left mb-2 flex items-center'>Save your presentation at no cost</h3>
                                    <p className='text-gray-800 text-left mb-6 leading-normal'>
                    ...
                    <div className='js-scroll md:mb-10 px-4 mx-auto w-full sm:max-w-screen-xl py-5 lg:px-8 scrolled'>
                        <h2 className='text-3xl font-bold mb-6 mx-auto text-left sm:text-4xl'>FAQs</h2>
                        <div className='flex flex-col gap-4'>
                            <div className='bg-gray-50 rounded-lg hover:bg-gray-100 py-2 md:px-7 px-4'>
                                <Accordion type="single" collapsible>
                                    <AccordionItem value="item-1">
                                        <AccordionTrigger className="font-bold text-lg">What is an AI-generated presentation?</AccordionTrigger>
                                        <AccordionContent className="text-gray-800 leading-normal text-base">
                                            <span>
                            ...
                            <div className='bg-gray-50 rounded-lg hover:bg-gray-100 py-2 md:px-7 px-4'>
                                <Accordion type="single" collapsible>
                                    <AccordionItem value="item-1">
                                        ...
                                        <AccordionContent className=" leading-normal text-gray-800 text-base">
                                            <span>
                    ...
                    <div className='container mx-auto'>
                        <div className='flex flex-wrap'>
                            ...
                            <div className='w-full flex flex-col items-center mt-8 sm:items-start sm:order-none sm:mt-4'>
                                ...
                                <div className="flex flex-wrap items-center justify-start mb-2 sm:grid sm:gap-2 sm:grid-cols-3 xl:grid-cols-5">
                                    ...
                                    <a
                                        href="https://www.instagram.com" target="_blank" rel="noreferrer" className="bg-instagram rounded flex items-center justify-center p-2 bg-instagram-gradient hover:opacity-95 mr-2 sm:mr-0 focus:outline-none share">
                                        <svg className="fill-current h-5 w-5 text-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href="https://www.youtube.com" target="_blank" rel="noreferrer" className="bg-youtube rounded flex items-center justify-center p-2 bg-red-700 hover:bg-red-600 mr-2 sm:mr-0 focus:outline-none share">
